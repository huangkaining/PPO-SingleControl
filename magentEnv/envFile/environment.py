...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        total_action_space = []
        u_action_space = spaces.Discrete(world.dim_p * self.num_good)
        #u_action_space = spaces.Discrete((world.dim_p * 2 + 1) * self.num_good)
        total_action_space.append(u_action_space)
        self.action_space.append(total_action_space[0])
        obs_dim = len(observation_callback(self.controllers[0], self.world))
    ...
    def step(self, action_n):
        ...
        for i, agent in enumerate(self.agents):
            self._set_action(action_n[i], agent, self.action_space[0])
        # advance world state
        self.world.step()
